...
// SetEnabled().
func NewGlobal() { _ = "STUB: not implemented"; return }
...
func SetEnabled(v bool) { _ = "STUB: not implemented"; return }
...
//	}
func NewPrefix() string { _ = "STUB: not implemented"; return "" }
...
func Mark(id, v string) string { _ = "STUB: not implemented"; return "" }

// Clear removes any stored zones for the given ID.
func Clear(id string) { _ = "STUB: not implemented"; return }

// Get returns the zone info of the given ID. If the ID is not known (yet),
// Get() returns nil.
func Get(id string) (a *ZoneInfo) { _ = "STUB: not implemented"; return nil }
...
func Scan(v string) string { _ = "STUB: not implemented"; return "" }
...
func AnyInBounds(model tea.Model, mouse tea.MouseMsg) { _ = "STUB: not implemented"; return }
